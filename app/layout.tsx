  ...
  return (
    <html lang="en">
      ...
      >
        <div
          role="none"
          className="w-full h-8 md:h-16 bg-background sticky top-0 overflow-hidden"
        />
        ...
        <div className="grid max-w-lg md:max-w-screen-md md:grid-cols-[190px_1fr] px-5 items-start mx-auto pb-8 md:pb-16 gap-8">
          <aside className="grid gap-4 mx-auto md:sticky md:top-16">
            ...
            <ul className="flex items-center gap-4 text-onBackgroundVariant mx-auto md:mx-0">
              <li>
                <a
          ...
          <div className="grid gap-6">
            <header className="sticky top-4 md:top-16 bg-background">
              <Navbar />
            </header>
